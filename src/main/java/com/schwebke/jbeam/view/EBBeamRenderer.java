...
/** Zeichnen und Selektionstest beim EBBeam */
public class EBBeamRenderer extends BeamRenderer
{
    ...
    /** Zeichnen */
    static void draw(View view, EBBeam beam)
    {
    ...
    static void drawElement(View view, EBBeam beam)
    {
	Color oldColor = view.getColor();
	double l = beam.getL();
	// Element
    ...
    private static void drawDisplaced(View view, EBBeam beam)
    {
    ...
    private static void drawStressResultant(View view, EBBeam beam, int sr)
    {
